...
export default function BasicInfo() {
  return (
    <div className="relative bg-mmYellow drop-shadow-xl w-screen flex flex-col justify-center items-center px-8 py-8">
      ...
      <div className="mb-4">
        ...
        <p className="text-xl text-mmDarkBlue max-w-4xl">
